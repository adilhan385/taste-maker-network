  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-serif font-bold">My Dishes</h2>
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label>Name *</Label>
                <Input value={formData.name} onChange={e => setFormData(prev => ({ ...prev, name: e.target.value }))} placeholder="Dish name" />
              </div>
              <div className="space-y-2">
                <Label>Price (USD) *</Label>
                <Input type="number" step="0.01" value={formData.price} onChange={e => setFormData(prev => ({ ...prev, price: e.target.value }))} placeholder="0.00" />
              </div>
            </div>

            <div className="space-y-2">
              <Label>Description</Label>
              <Textarea value={formData.description} onChange={e => setFormData(prev => ({ ...prev, description: e.target.value }))} placeholder="Describe your dish..." rows={3} />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input value={formData.portion_size} onChange={e => setFormData(prev => ({ ...prev, portion_size: e.target.value }))} placeholder="e.g., 500g, 2 pieces, Large bowl" />
            </div>

            <div className="space-y-2">
              <Label>Ingredients (comma separated)</Label>
              <Input value={formData.ingredients} onChange={e => setFormData(prev => ({ ...prev, ingredients: e.target.value }))} placeholder="chicken, rice, vegetables, spices" />
            </div>

            <div className="space-y-2">
              <Label>Allergens (comma separated)</Label>
              <Input value={formData.allergens} onChange={e => setFormData(prev => ({ ...prev, allergens: e.target.value }))} placeholder="nuts, dairy, gluten" />
            </div>
