...
export default function ChefProfileTab() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-serif font-bold">Chef Profile</h2>
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <Badge variant="secondary" className="mt-2">Verified Chef</Badge>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Tell customers about your cooking style and experience</CardDescription>
          </CardHeader>
          <CardContent>
            <Textarea
              value={formData.bio}
              onChange={e => setFormData(prev => ({ ...prev, bio: e.target.value }))}
              placeholder="I've been cooking for 10 years, specializing in..."
              rows={4}
            />
          </CardContent>
        </Card>
      ...
      {/* Chef Application Info */}
      {chefData && (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
          <Card>
            <CardHeader>
              <CardTitle>Chef Verification Details</CardTitle>
              <CardDescription>Information from your approved application</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="flex justify-between">
                <span className="text-muted-foreground">Cuisine Specialization</span>
                <span className="font-medium">{chefData.cuisine_specialization}</span>
              </div>
              <div className="flex justify-between">
