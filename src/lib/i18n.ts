...
export const translations = {
  en: {
    ...
    'becomeChef.idDocument': 'ID document with your face visible',
    'becomeChef.idDocumentHint': 'Upload a photo of your ID or passport where your face is clearly visible',
    'becomeChef.medicalCert': 'Medical certificate (optional)',
    'becomeChef.medicalCertHint': 'Optional. Chefs with a medical certificate get a green badge in the catalog and more trust from buyers.',
    'chef.rankProgress': 'Rank progress: {done} of {total} delivered orders to the next rank',
    'chef.rankMax': 'You have reached the highest rank 💎',
    'catalog.medCertYes': 'Medical certificate ✓',
    'catalog.medCertNo': 'No medical certificate',
    'becomeChef.profilePhoto': 'Profile Photo (Optional)',
    'becomeChef.clickToUpload': 'Click to upload',
    'becomeChef.facePhoto': 'Photo of your face (selfie)',
    'becomeChef.facePhotoHint': 'A clear selfie so we can match it with your ID',
    'becomeChef.kitchenPhoto': 'Photo of your kitchen',
    'becomeChef.kitchenPhotoHint': 'Show the place where you cook — it must be clean and tidy',
    'becomeChef.citySelect': 'Select your city',
    'becomeChef.phoneVerified': 'Phone verified during registration',
    'becomeChef.phoneVerifyHint': 'We need to confirm your phone number with an SMS code',
    'becomeChef.sendCode': 'Send code',
    'becomeChef.enterCode': 'Code from SMS',
    'becomeChef.verifyCode': 'Confirm',
    'becomeChef.phoneOk': 'Phone confirmed',
    ...
    'auth.emailTaken': 'This email is already in use. Sign in or reset your password.',
    'auth.phoneRequired': 'Phone number is required',
    'auth.verifyMethod': 'Verification method',
    'auth.verifyByEmail': 'By email',
    'auth.verifyBySms': 'By SMS',
    'auth.verifyEmailTitle': 'Verify your email',
    'auth.enterEmailCode': 'Enter the code from the email',
    'auth.codeLengthHint': 'The code may be 6 or 8 digits — enter it exactly as in the email',
    'auth.verifyEmailBtn': 'Verify email',
    'auth.emailVerified': 'Email verified!',
    'auth.emailVerifiedDesc': 'Your registration is complete',
    ...
    // Appeals
    'chef.appealReview': 'Appeal',
    'chef.appealReason': 'Reason for appeal',
    'chef.appealReasonPlaceholder': 'Explain why this review should be removed...',
    'chef.appealSubmit': 'Submit Appeal',
    'chef.appealSubmitted': 'Appeal submitted',
    'chef.appealSubmittedDesc': 'Your appeal has been sent to admin for review.',
    'chef.appealPending': 'Appeal pending',
    'chef.appealApproved': 'Appeal approved',
    'chef.appealRejected': 'Appeal rejected',
    'admin.reviewAppeals': 'Appeals',
    'admin.deleteReview': 'Delete Review',
    'admin.rejectAppeal': 'Reject Appeal',
    'admin.appealApproved': 'Review deleted, appeal approved',
    'admin.appealRejected': 'Appeal rejected',
    'admin.noAppeals': 'No pending appeals',
    'admin.appealReason': 'Appeal reason',
    'admin.reviewDetails': 'Review details',
    'admin.appealsCount': 'appeals',
  },
  ru: {
    // Navigation
    'nav.catalog': 'Каталог',
    ...
    'becomeChef.idDocument': 'Удостоверение личности с вашим лицом',
    'becomeChef.idDocumentHint': 'Загрузите фото удостоверения или паспорта, где чётко видно ваше лицо',
    'becomeChef.medicalCert': 'Медицинская справка (необязательно)',
    'becomeChef.medicalCertHint': 'Необязательно. Повара со справкой получают зелёную отметку в каталоге и больше доверия покупателей.',
    'chef.rankProgress': 'Прогресс ранга: {done} из {total} выполненных заказов до следующего ранга',
    'chef.rankMax': 'Вы достигли высшего ранга 💎',
    'catalog.medCertYes': 'Есть медсправка ✓',
    'catalog.medCertNo': 'Нет медсправки',
    'becomeChef.profilePhoto': 'Фото профиля (необязательно)',
    'becomeChef.clickToUpload': 'Нажмите для загрузки',
    'becomeChef.facePhoto': 'Фото вашего лица (селфи)',
    'becomeChef.facePhotoHint': 'Чёткое селфи, чтобы сверить его с удостоверением',
    'becomeChef.kitchenPhoto': 'Фото вашей кухни',
    'becomeChef.kitchenPhotoHint': 'Покажите место, где вы готовите — оно должно быть чистым',
    'becomeChef.citySelect': 'Выберите город',
    'becomeChef.phoneVerified': 'Телефон подтверждён при регистрации',
    'becomeChef.phoneVerifyHint': 'Нужно подтвердить номер телефона кодом из SMS',
    'becomeChef.sendCode': 'Отправить код',
    'becomeChef.enterCode': 'Код из SMS',
    'becomeChef.verifyCode': 'Подтвердить',
    'becomeChef.phoneOk': 'Номер подтверждён',
    ...
    'auth.emailTaken': 'Эта почта уже используется. Войдите или восстановите пароль.',
    'auth.phoneRequired': 'Номер телефона обязателен',
    'auth.verifyMethod': 'Способ подтверждения',
    'auth.verifyByEmail': 'По почте',
    'auth.verifyBySms': 'По SMS',
    'auth.verifyEmailTitle': 'Подтверждение почты',
    'auth.enterEmailCode': 'Введите код из письма',
    'auth.codeLengthHint': 'Код может быть из 6 или 8 цифр — введите его точно как в письме',
    'auth.verifyEmailBtn': 'Подтвердить почту',
    'auth.emailVerified': 'Почта подтверждена!',
    'auth.emailVerifiedDesc': 'Регистрация успешно завершена',
    ...
    // Appeals
    'chef.appealReview': 'Апелляция',
    'chef.appealReason': 'Причина апелляции',
    'chef.appealReasonPlaceholder': 'Объясните, почему этот отзыв должен быть удалён...',
    'chef.appealSubmit': 'Подать апелляцию',
    'chef.appealSubmitted': 'Апелляция подана',
    'chef.appealSubmittedDesc': 'Ваша апелляция отправлена админу на рассмотрение.',
    'chef.appealPending': 'Апелляция на рассмотрении',
    'chef.appealApproved': 'Апелляция одобрена',
    'chef.appealRejected': 'Апелляция отклонена',
    'admin.reviewAppeals': 'Апелляции',
    'admin.deleteReview': 'Удалить отзыв',
    'admin.rejectAppeal': 'Отклонить апелляцию',
    'admin.appealApproved': 'Отзыв удалён, апелляция одобрена',
    'admin.appealRejected': 'Апелляция отклонена',
    'admin.noAppeals': 'Нет апелляций на рассмотрении',
    'admin.appealReason': 'Причина апелляции',
    'admin.reviewDetails': 'Детали отзыва',
    'admin.appealsCount': 'апелляций',
  },
  kz: {
    // Navigation
    'nav.catalog': 'Каталог',
    ...
    'becomeChef.idDocument': 'Бетіңіз көрінетін жеке куәлік',
    'becomeChef.idDocumentHint': 'Бетіңіз анық көрінетін жеке куәлік немесе паспорт суретін жүктеңіз',
    'becomeChef.medicalCert': 'Медициналық анықтама (міндетті емес)',
    'becomeChef.medicalCertHint': 'Міндетті емес. Анықтамасы бар аспаздар каталогта жасыл белгі алады және сатып алушылардың сенімін арттырады.',
    'chef.rankProgress': 'Ранг прогресі: келесі рангке дейін {total} тапсырыстан {done} орындалды',
    'chef.rankMax': 'Сіз ең жоғары рангке жеттіңіз 💎',
    'catalog.medCertYes': 'Медициналық анықтама бар ✓',
    'catalog.medCertNo': 'Медициналық анықтама жоқ',
    'becomeChef.profilePhoto': 'Профиль суреті (міндетті емес)',
    'becomeChef.clickToUpload': 'Жүктеу үшін басыңыз',
    'becomeChef.facePhoto': 'Бетіңіздің фотосы (селфи)',
    'becomeChef.facePhotoHint': 'Жеке куәлікпен салыстыру үшін анық селфи',
    'becomeChef.kitchenPhoto': 'Асүйіңіздің фотосы',
    'becomeChef.kitchenPhotoHint': 'Тамақ дайындайтын жеріңізді көрсетіңіз — таза болуы керек',
    'becomeChef.citySelect': 'Қалаңызды таңдаңыз',
    'becomeChef.phoneVerified': 'Телефон тіркелу кезінде расталды',
    'becomeChef.phoneVerifyHint': 'Телефон нөмірін SMS кодымен растау қажет',
    'becomeChef.sendCode': 'Код жіберу',
    'becomeChef.enterCode': 'SMS коды',
    'becomeChef.verifyCode': 'Растау',
    'becomeChef.phoneOk': 'Нөмір расталды',
    ...
    'auth.emailTaken': 'Бұл пошта бұрыннан қолданылуда. Жүйеге кіріңіз немесе құпия сөзді қалпына келтіріңіз.',
    'auth.phoneRequired': 'Телефон нөмірі міндетті',
    'auth.verifyMethod': 'Растау әдісі',
    'auth.verifyByEmail': 'Пошта арқылы',
    'auth.verifyBySms': 'SMS арқылы',
    'auth.verifyEmailTitle': 'Поштаны растау',
    'auth.enterEmailCode': 'Поштаға жіберілген кодты енгізіңіз',
    'auth.codeLengthHint': 'Код 6 немесе 8 таңбадан болуы мүмкін — хаттағыдай енгізіңіз',
    'auth.verifyEmailBtn': 'Поштаны растау',
    'auth.emailVerified': 'Пошта расталды!',
    'auth.emailVerifiedDesc': 'Тіркелуіңіз сәтті аяқталды',
    ...
    // Appeals
    'chef.appealReview': 'Апелляция',
    'chef.appealReason': 'Апелляция себебі',
    'chef.appealReasonPlaceholder': 'Бұл пікірді неге жою керектігін түсіндіріңіз...',
    'chef.appealSubmit': 'Апелляция беру',
    'chef.appealSubmitted': 'Апелляция берілді',
    'chef.appealSubmittedDesc': 'Сіздің апелляцияңыз әкімшіге жіберілді.',
    'chef.appealPending': 'Апелляция қаралуда',
    'chef.appealApproved': 'Апелляция мақұлданды',
    'chef.appealRejected': 'Апелляция қабылданбады',
    'admin.reviewAppeals': 'Апелляциялар',
    'admin.deleteReview': 'Пікірді жою',
    'admin.rejectAppeal': 'Апелляцияны қабылдамау',
    'admin.appealApproved': 'Пікір жойылды, апелляция мақұлданды',
    'admin.appealRejected': 'Апелляция қабылданбады',
    'admin.noAppeals': 'Қаралатын апелляциялар жоқ',
    'admin.appealReason': 'Апелляция себебі',
    'admin.reviewDetails': 'Пікір мәліметтері',
    'admin.appealsCount': 'апелляция',
  },
};
