...
export const translations = {
  en: {
    ...
    'auth.enterEmailCode': 'Enter the 6-digit code from the email',
  ...
  ru: {
    ...
    'auth.enterEmailCode': 'Введите 6-значный код из письма',
  ...
  kz: {
    ...
    'auth.enterEmailCode': 'Поштаға жіберілген 6 таңбалы кодты енгізіңіз',
